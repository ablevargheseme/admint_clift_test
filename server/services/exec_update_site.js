...
const update_site = (campaignId, name) => {
    ...
    // const terminalCommand = `node update_site.js ${campaignId} ${name}`;
    // // Define the working directory where the command will be executed
    // const workingDirectory = '../scripts'; // Replace this with the actual path
    
    // // Execute the terminal command in the specified working directory
    // exec(terminalCommand, { cwd: workingDirectory }, (error, stdout, stderr) => {
    //     if (error) {
